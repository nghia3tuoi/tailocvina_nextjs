...
const PhoneDynamic = () => {
  return (
    <div className="w-12 h-12 fixed bottom-0 right-0 mr-5 mb-10  ">
      ...
      <Link href="tel:0989015053"  target="_parent" className="absolute bg-[#16a34a] rounded-full w-12 h-12 animate-bounce block"  aria-label="liên hệ phế liệu tài lộc vi na qua số điện thoại">
