...
const ZaloDynamic = () => {
  return (
    <div className="w-12 h-12  fixed bottom-0 right-0 mr-5 mb-36  ">
      ...
      <Link href="zalo://contact?number=0989015053"  rel="noopener noreferrer" target="_blank" className="absolute animate-bounce block"   aria-label="liên hệ phế liệu tài lộc vi na qua zalo">
